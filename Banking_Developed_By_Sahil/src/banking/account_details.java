 ...
 * @author Sahil
 */
public class account_details extends javax.swing.JInternalFrame implements myvariables
{
            ...
            try
            {
               ...
               try
               {
                ...
                ResultSet myresult = mystatement2.executeQuery();
                    ...
                    if(myresult.next())
                    {
                        String locker_no = myresult.getString("locker_no");
                        
                        jTextField13.setText(locker_no);
                    }
                }
