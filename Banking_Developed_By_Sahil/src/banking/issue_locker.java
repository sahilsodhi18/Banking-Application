 ...
 * @author Sahil
 */
public class issue_locker extends javax.swing.JInternalFrame implements myvariables
{
    int total_lockers = 0;
    /**
                ...
                ResultSet rs3 = mystatement3.executeQuery();
                    ...
                    if(rs3.next())
                    {
                     ...
                     l  = rs3.getString("locker_no");
                        ...
                        if(!l.equals(""))
                        {
                            JOptionPane.showMessageDialog(rootPane,"Locker has already been Issued to this Account .");
                        }
                        ...
                        else
                        {
                         ...
                         mystatement2.setString(2,cdate);
                         
                         
                         
                         mystatement2.setString(3,"Occupied");
                         mystatement2.executeUpdate();

                         JOptionPane.showMessageDialog(rootPane,"Locker has been Issued .");
