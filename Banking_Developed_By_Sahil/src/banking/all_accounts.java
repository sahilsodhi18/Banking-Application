 ...
 * @author Sahil
 */
public class all_accounts extends javax.swing.JInternalFrame implements myvariables
{
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Choose_Category" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Account No", "Customer Name", "Gender", "Occupation", "Phone", "Current Balance", "ATM Card No", "Account Status"
            }
        ));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Choose", "Account_No", "Customer_Name" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Choose_Subcategory" }));
        ...
        try
            {
                ...
                if(myresult.next())
                {
                    do
                    {
                        if(!myresult.getString("category_name").equals("Department") && !myresult.getString("category_name").equals("Employee_Status"))
                        {
                ...
                String q2 = "select * from customer_table";
                ...
                if(myresult2.next())
                {
                    do
                    {
                        String acc_no = myresult2.getString("account_no");
                        String c_name = myresult2.getString("customer_name");
                        String gender = myresult2.getString("gender");
                        String occ = myresult2.getString("occupation");
                        String phone = myresult2.getString("phone");
                        String t_amt = myresult2.getString("total_amount");
                        String atm = myresult2.getString("atm_card_no");
                        String status = myresult2.getString("status");
                        
                        
                        mymodel.addRow(new Object[] {acc_no,c_name,gender,occ,phone,t_amt,atm,status});
                    }
        ...
        try
            {
                ...
                {
                    String q = "select * from customer_table where account_no like ?";
                    ...
                    mymodel.setRowCount(0);
                        ...
                        if(myresult.next())
                        {
                            do
                            {
                                ...
                                String occ = myresult.getString("occupation");
                                String phone = myresult.getString("phone");
                                String t_amt = myresult.getString("total_amount");
                                String atm = myresult.getString("atm_card_no");
                ...
                {
                    String q = "select * from customer_table where customer_name like ?";
         ...
         try
            {
                ...
                try
                {
                String q = "select * from customer_table where gender = ? or occupation = ? or status = ?";
               ...
               jTable1.getColumnModel().getColumn(1).setPreferredWidth(50);
                ...
                if(myresult.next())
                {
                    do
                    {
                        String acc = myresult.getString("account_no");
                        String c_name = myresult.getString("customer_name");
                        String gender = myresult.getString("gender");
                        String occ = myresult.getString("occupation");
                       
                        String ph = myresult.getString("phone");
                        String t_amt = myresult.getString("total_amount");
                        String atm = myresult.getString("atm_card_no");
                        String st = myresult.getString("status");
                        
                        mymodel.addRow(new Object[] {acc,c_name,gender,occ,ph,t_amt,atm,st});
