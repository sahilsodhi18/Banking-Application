 ...
 * @author Sahil
 */
public class issue_atm_card extends javax.swing.JInternalFrame implements myvariables
{

    /**
     * Creates new form update_delete_account
     */
    public issue_atm_card() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Issue_ATM_Card");
               ...
               try
               {
                ...
                ResultSet rs = mystatement.executeQuery();
                    ...
                    if(rs.next())
                    {
                     ...
                     atm_card_no = rs.getString("atm_card_no");

                    }
                    
                    if(atm_card_no.equals("-"))
                    {
                    
                        if(status.equals("Deactivated") )
                        {
                            JOptionPane.showConfirmDialog(rootPane,"This Account is not Activated .","Cannot Issue ATM Card .",JOptionPane.CANCEL_OPTION,JOptionPane.ERROR_MESSAGE);
                        }
                        else if( c_amt <= 1500)
                        {
                            JOptionPane.showConfirmDialog(rootPane,"This Account is having less than Rs. 1500 ","Cannot Issue ATM Card .",JOptionPane.CANCEL_OPTION,JOptionPane.ERROR_MESSAGE);
                        }
                        else
                        {
                         String q2 = "insert into atm_card_table values(?,?,?,?)";

                         PreparedStatement mystatement2 = myconnection.prepareStatement(q2);

                         mystatement2.setString(1, jTextField1.getText());
                         mystatement2.setString(2, jTextField9.getText());
                         ...
                         mystatement2.setString(3,cdate);
                         mystatement2.setString(4,"");
                         ...
                         JOptionPane.showMessageDialog(rootPane,"ATM card has been Issued .");
                    ...
                    {
                        JOptionPane.showMessageDialog(rootPane,"ATM Card has already been issued to this Account .");
                    }
    ...
    void generate_atm_card_no()
    {
        try
        {
            ...
            try
            {
                String q = "select max(atm_card_no) from atm_card_table";
                PreparedStatement mystatement = myconnection.prepareStatement(q);
                ResultSet myresult = mystatement.executeQuery();
                
                if(myresult.next())
                {
                    int atm_card_no = myresult.getInt(1);
                    
                    jTextField9.setText(String.valueOf(++atm_card_no));
                }
                else
                {
                    jTextField9.setText("1001");
                }
